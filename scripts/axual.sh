...
color07="DB/DB/D2" # Grey

# Bright
color08="74/87/8F" # Dark Grey
...
color15="F7/F7/F5" # White

# 256 color
color208="E4/8C/4F" # Orange
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pi F7F7F5 # bold color
