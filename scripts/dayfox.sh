...
# Normal
color00="E7/E3/DF" # Black
color01="a5/22/2f" # Red
color02="39/68/47" # Green
color03="ac/54/02" # Yellow
color04="28/48/a9" # Blue
color05="6e/33/ce" # Magenta
color06="28/79/80" # Cyan
color07="3d/2b/5a" # Grey

# Bright
color08="AB/A0/BA" # Dark Grey
color09="87/00/1B" # Red
color10="19/53/2E" # Green
color11="8B/42/00" # Yellow
color12="10/29/9B" # Blue
color13="5A/00/B6" # Magenta
color14="00/62/69" # Cyan
color15="24/11/3E" # White

# 256 color
color208="A9/3E/22" # Orange

# Base
color_background="f6/f2/ee" # Black
color_foreground="3d/2b/5a" # Grey
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg 3d2b5a # foreground
  put_template_custom Ph f6f2ee # background
  put_template_custom Pi 24113E # bold color
  put_template_custom Pj ac5402 # selection color
  put_template_custom Pk f6f2ee # selected text color
  put_template_custom Pl 3d2b5a # cursor
