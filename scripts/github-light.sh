...
if [ "${WALH_SYNC_FZF:-}" = "1" ]; then
  export FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS:+${FZF_DEFAULT_OPTS} }--color=bg:#ffffff,bg+:#970b16,fg:#3e3e3e,fg+:#5C8DA0,hl:#003e8a,hl+:#003e8a,info:#07962a,prompt:#07962a,pointer:#5C8DA0,marker:#5C8DA0,spinner:#5C8DA0,header:#003e8a"
fi
