...
# Normal
color00="EC/EC/EC" # Black
color01="de/3d/3b" # Red
color02="08/91/6a" # Green
color03="da/aa/01" # Yellow
color04="28/8e/d7" # Blue
color05="d6/43/8a" # Magenta
color06="2a/a2/98" # Cyan
color07="40/3f/53" # Grey

# Bright
color08="AF/AE/BA" # Dark Grey
color09="C6/00/1A" # Red
color10="00/76/56" # Green
color11="BC/92/00" # Yellow
color12="00/75/BA" # Blue
color13="C2/00/73" # Magenta
color14="00/89/80" # Cyan
color15="27/26/38" # White

# 256 color
color208="DF/7A/2E" # Orange

# Base
color_background="fb/fb/fb" # Black
color_foreground="40/3f/53" # Grey
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg 403f53 # foreground
  put_template_custom Ph fbfbfb # background
  put_template_custom Pi 272638 # bold color
  put_template_custom Pj daaa01 # selection color
  put_template_custom Pk fbfbfb # selected text color
  put_template_custom Pl 403f53 # cursor
  put_template_custom Pm fbfbfb # cursor text
else
