...
color01="e5/39/35" # Red
color02="91/b8/59" # Green
color03="f6/a4/34" # Yellow
color04="61/82/b8" # Blue
color05="7c/4d/ff" # Magenta
color06="39/ad/b5" # Cyan
color07="54/6e/7a" # Grey

# Bright
color08="B5/C3/CA" # Dark Grey
color09="CA/00/15" # Red
color10="75/A0/2B" # Green
color11="DB/8B/00" # Yellow
color12="45/6A/A6" # Blue
color13="6A/03/F5" # Magenta
color14="00/94/9D" # Cyan
color15="39/52/5D" # White

# 256 color
color208="F0/74/36" # Orange

# Base
color_background="fa/fa/fa" # Black
color_foreground="54/6e/7a" # Grey
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg 546e7a # foreground
  put_template_custom Ph fafafa # background
  put_template_custom Pi 39525D # bold color
  put_template_custom Pj f6a434 # selection color
  put_template_custom Pk fafafa # selected text color
  put_template_custom Pl 546e7a # cursor
