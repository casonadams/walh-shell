...
export WALH_THEME="monokai-machine"
export WALH_MODE="dark"
export WALH_BG="#23201f"
...
if [ "${WALH_SYNC_FZF:-}" = "1" ]; then
  export FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS:+${FZF_DEFAULT_OPTS} }--color=bg:#23201f,bg+:#ff6188,fg:#f8f8f2,fg+:#78dce8,hl:#78dce8,hl+:#78dce8,info:#a9dc76,prompt:#a9dc76,pointer:#78dce8,marker:#78dce8,spinner:#78dce8,header:#78dce8"
fi
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pm 23201f # cursor text
else
