...
# Base
color_background="2c/25/25" # Black
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Ph 2c2525 # background
  put_template_custom Pi FDFDFC # bold color
  put_template_custom Pj ffd866 # selection color
  put_template_custom Pk 2c2525 # selected text color
  put_template_custom Pl f8f8f2 # cursor
  put_template_custom Pm 2c2525 # cursor text
else
