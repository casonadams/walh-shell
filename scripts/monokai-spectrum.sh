...
# Base
color_background="22/24/30" # Black
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Ph 222430 # background
  put_template_custom Pi FDFDFC # bold color
  put_template_custom Pj ffd866 # selection color
  put_template_custom Pk 222430 # selected text color
  put_template_custom Pl f8f8f2 # cursor
  put_template_custom Pm 222430 # cursor text
else
