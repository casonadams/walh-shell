...
# Normal
color00="DD/E0/E5" # Black
color01="bf/61/6a" # Red
color02="a3/be/8c" # Green
color03="eb/cb/8b" # Yellow
color04="5e/81/ac" # Blue
color05="b4/8e/ad" # Magenta
color06="88/c0/d0" # Cyan
color07="2e/34/40" # Grey

# Bright
color08="9D/A3/AC" # Dark Grey
color09="AC/42/50" # Red
color10="88/A6/6D" # Green
color11="D5/B0/66" # Yellow
color12="42/69/99" # Blue
color13="9E/74/97" # Magenta
color14="67/A8/BA" # Cyan
color15="16/1C/26" # White

# 256 color
color208="D7/96/7B" # Orange

# Base
color_background="ec/ef/f4" # Black
color_foreground="2e/34/40" # Grey
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Ph eceff4 # background
  put_template_custom Pi 161C26 # bold color
  ...
  put_template_custom Pm eceff4 # cursor text
else
