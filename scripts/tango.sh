...
color07="19/FF/19" # Grey

# Bright
color08="00/7F/00" # Dark Grey
color09="CC/00/00" # Red
color10="73/D2/16" # Green
color11="ED/D4/00" # Yellow
color12="34/65/A4" # Blue
color13="75/50/7B" # Magenta
color14="06/98/9A" # Cyan
color15="CC/FF/CC" # White

# 256 color
color208="DC/6A/00" # Orange
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pi CCFFCC # bold color
