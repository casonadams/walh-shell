...
color07="B1/B8/DA" # Grey

# Bright
color08="73/7A/98" # Dark Grey
...
color15="ED/EF/F6" # White

# 256 color
color208="EB/92/7B" # Orange
...
export WALH_THEME="tokyo-night-storm"
export WALH_MODE="dark"
export WALH_BG="#24283B"
...
if [ "${WALH_SYNC_FZF:-}" = "1" ]; then
  export FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS:+${FZF_DEFAULT_OPTS} }--color=bg:#24283B,bg+:#F7768E,fg:#A9B1D6,fg+:#449DAB,hl:#7AA2F7,hl+:#7AA2F7,info:#9ECE6A,prompt:#9ECE6A,pointer:#449DAB,marker:#449DAB,spinner:#449DAB,header:#7AA2F7"
fi
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pi EDEFF6 # bold color
