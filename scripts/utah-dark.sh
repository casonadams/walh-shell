...
color07="78/79/78" # Grey

# Bright
color08="39/3B/3A" # Dark Grey
...
color15="E1/E1/E1" # White

# 256 color
color208="77/4E/37" # Orange
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pi E1E1E1 # bold color
