...
color02="00/80/00" # Green
color03="79/5e/26" # Yellow
color04="04/51/a5" # Blue
color05="bc/3f/bc" # Magenta
color06="09/86/58" # Cyan
color07="1e/1e/1e" # Grey

# Bright
color08="A1/A1/A1" # Dark Grey
color09="B1/00/16" # Red
color10="00/65/00" # Green
color11="63/47/00" # Yellow
color12="00/3C/7F" # Blue
color13="A7/00/A8" # Magenta
color14="00/6C/45" # Cyan
color15="08/08/08" # White

# 256 color
color208="A5/4F/2C" # Orange

# Base
color_background="ff/ff/ff" # Black
color_foreground="1e/1e/1e" # Grey
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg 1e1e1e # foreground
  put_template_custom Ph ffffff # background
  put_template_custom Pi 080808 # bold color
  put_template_custom Pj 795e26 # selection color
  put_template_custom Pk ffffff # selected text color
  put_template_custom Pl 1e1e1e # cursor
